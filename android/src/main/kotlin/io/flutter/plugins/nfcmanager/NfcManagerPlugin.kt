  ...
  private fun handleNfcStartSession(call: MethodCall, result: Result) {
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
      ...
      adapter.enableReaderMode(activity, {
        ...
        tags[handle] = it
          // Inside the NFC reading logic, configure the EMV library to read card data
        ...
        val date = card?.expireDate.format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy"))
